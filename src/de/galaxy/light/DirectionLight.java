...
{	
	...
	{
		shader.setVec3(gl, "dirLight.direction", direction);
		
		shader.setVec3(gl, "dirLight.ambient", color.Mul(ambient));
		shader.setVec3(gl, "dirLight.diffuse", color.Mul(diffuse));
		shader.setVec3(gl, "dirLight.specular", color);
	}
}
