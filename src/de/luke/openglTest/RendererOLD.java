...
public class RendererOLD implements GLEventListener
{
	...
	public void init(GLAutoDrawable drawable) 
	{
		...
		Scene testScene = new Scene("assets/scenes/EngineTestScene.json", true, gl);
		...
		myModel = ModelLoader.load(gl, "backback", shaderList.get(0), true, false);
		myModel.position = new Vector3(0.0f, 5.0f, -5.0f);
		...
		Texture2D brickWallSpecular = new Texture2D("assets/textures/brickwall_specular.jpg", gl, shaderList.get(0), 1, Texture2D.TEXTURE_SPECULAR, 32.0f);
		Texture2D brickWallNormal = new Texture2D("assets/textures/brickwall_normal.jpg", gl, shaderList.get(0), 2, Texture2D.TEXTURE_NORMAL, 32.0f);

		brickWall = ModelBuilder.CreatePlane(gl, new Texture2D[] {brickWallDiffuse, brickWallSpecular, brickWallNormal}, true);
		...
		skybox = new Skybox(gl, new String[] {
